...
export class DataService {
  ...
  ilanListele() {
    return this.http.get<odev[]>(this.apiUrl + "lessons");
  }
  ilanListeleByKatId(katId: number) {
    return this.http.get<odev[]>(this.apiUrl + "categories/" + katId + "/lessons");
  }
  ilanById(id: number) {
    return this.http.get<odev>(this.apiUrl + "lessons/" + id);
  }
  ilanEkle(ilan: odev) {
